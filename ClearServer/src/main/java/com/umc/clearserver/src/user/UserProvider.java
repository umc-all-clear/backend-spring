...
//            // 회원가입할때 비밀번호가 암호화되어 저장되었기 떄문에 로그인을 할때도 암호화된 값끼리 비교를 해야합니다.
...
//            //Boolean userStatus = userDao.getPwd(postLoginReq).getstate();
////            return new PostLoginRes(userIdx, userStatus);
////  *********** 해당 부분은 7주차 - JWT 수업 후 주석해제 및 대체해주세요!  **************** //
//            String jwt = jwtService.createJwt(userIdx);
//            return new PostLoginRes(userIdx, /*userStatus,*/ jwt);
////  **************************************************************************
//
