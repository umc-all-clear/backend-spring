...
public class FriendProvider {
    ...
    public List<GetFriendRelationRes> getFriendRelation(String user1, String user2) throws BaseException {
        try {
            List<GetFriendRelationRes> getFriendRelationRes = friendDao.getFriendRelation(user1, user2);
